 ...
 */
class SpecIsRoleUser extends AbstractSpecification
{

    /**
     * Returns true if the role "user" is granted by the given object. False otherwise.
     *
    ...
    {
        return $object->value->isGranted('ROLE_USER');
    }
}
