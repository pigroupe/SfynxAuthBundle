 ...
 */
namespace Sfynx\AuthBundle\Application\Validation\Validator;
...
//        exit;
    ...
    protected function setValidationErrors($errorType, $errorMessage)
    {
    ...
    protected function validateAdress()
    {
