 ...
 */
namespace Sfynx\AuthBundle\Infrastructure\Role;
...
class RoleFactory extends AbstractFactory implements RoleFactoryInterface
{
    ...
    public function getAllUserRoles()
    {
        if ($this->isUsernamePasswordToken()) {
            return array_unique(array_merge(
                $this->getAllHeritageByRoles($this->getBestRoles($this->getUserRoles())),
                $this->getUserRoles()
            ));
        }
        return null;
     ...
     * @author Etienne de Longeaux <etienne.delongeaux@gmail.com>
     */
    public function setJsonFileRoles($isForce = true)
    {
        if ($isForce
